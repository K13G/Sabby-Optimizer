...
public sealed class NavigationService : INavigationService
{
    ...
    public void NavigateTo(AppPage page)
    {
        ...
        try
        {
            ...
            // A page-change subscriber must never take down the whole app. Notify each
            // subscriber independently so one presentation fault cannot crash a tab click.
            ...
            foreach (EventHandler handler in handlers)
            {
                ...
                {
                    // The shell has global UI logging/recovery; navigation itself stays valid.
                }
            }
        }
        catch
